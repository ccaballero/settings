...
-- {{{ Main
theme = {}
theme.wallpaper = '/home/jacobian/.config/awesome/themes/09/background-1920x1080.png'
-- }}}
...
-- {{{ Misc
theme.awesome_icon           = '/home/jacobian/.config/awesome/themes/09/awesome-icon.png'
