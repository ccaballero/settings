...
-- {{{ Main
theme = {}
theme.wallpaper = '/home/jacobian/.config/awesome/themes/Wed/background-1920x1080.png'
-- }}}
...
-- {{{ Misc
theme.awesome_icon           = '/home/jacobian/.config/awesome/themes/Wed/awesome-icon.png'
