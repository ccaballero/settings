...
-- {{{ Main
theme = {}
theme.wallpaper = '/home/jacobian/.config/awesome/themes/07-background-1920x1080.png'
-- }}}
...
-- {{{ Misc
theme.awesome_icon           = '/home/jacobian/.config/awesome/themes/07-awesome-icon.png'
...
theme.transmission_icon = '/usr/share/icons/AwOkenWhite/clear/128x128/apps/transmission.png'
